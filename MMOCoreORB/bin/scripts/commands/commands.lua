...
RunSlashCommandsFile("petAttack.lua")
RunSlashCommandsFile("petClearPatrolPoints.lua")
...
RunSlashCommandsFile("petGuard.lua")
RunSlashCommandsFile("petHarvest.lua")
RunSlashCommandsFile("petPatrol.lua")
RunSlashCommandsFile("petRangedAttack.lua")
RunSlashCommandsFile("petRecharge.lua")
RunSlashCommandsFile("petRechargeOther.lua")
RunSlashCommandsFile("petRecover.lua")
RunSlashCommandsFile("petRepair.lua")
RunSlashCommandsFile("petSpecialAttack.lua")
RunSlashCommandsFile("petStay.lua")
RunSlashCommandsFile("petStore.lua")
RunSlashCommandsFile("petThrow.lua")
RunSlashCommandsFile("petTransfer.lua")
RunSlashCommandsFile("petTrick.lua")
