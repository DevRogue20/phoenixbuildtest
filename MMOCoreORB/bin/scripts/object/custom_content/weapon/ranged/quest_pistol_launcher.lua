...
object_weapon_ranged_pistol_quest_pistol_launcher = object_weapon_ranged_pistol_shared_quest_pistol_launcher:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_quest_pistol_launcher, "object/weapon/ranged/pistol/quest_pistol_launcher.iff")
