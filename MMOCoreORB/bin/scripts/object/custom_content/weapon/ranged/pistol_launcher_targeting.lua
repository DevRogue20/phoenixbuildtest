...
object_weapon_ranged_pistol_pistol_launcher_targeting = object_weapon_ranged_pistol_shared_pistol_launcher_targeting:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_launcher_targeting, "object/weapon/ranged/pistol/pistol_launcher_targeting.iff")
