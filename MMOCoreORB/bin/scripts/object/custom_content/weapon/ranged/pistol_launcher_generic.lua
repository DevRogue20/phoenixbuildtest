...
object_weapon_ranged_pistol_pistol_launcher_generic = object_weapon_ranged_pistol_shared_pistol_launcher_generic:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_launcher_generic, "object/weapon/ranged/pistol/pistol_launcher_generic.iff")
