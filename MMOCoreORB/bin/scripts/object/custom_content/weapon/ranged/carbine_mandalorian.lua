...
object_weapon_ranged_carbine_carbine_mandalorian = object_weapon_ranged_carbine_shared_carbine_mandalorian:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_carbine_carbine_mandalorian, "object/weapon/ranged/carbine/carbine_mandalorian.iff")
