...
object_draft_schematic_space_capacitor_capacitor_mk5 = object_draft_schematic_space_capacitor_shared_capacitor_mk5:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mark V Weapons Capacitor",
   ...
   targetTemplate = "object/tangible/ship/crafted/capacitor/capacitor_mk5.iff",

   additionalTemplates = {
              "object/tangible/ship/crafted/capacitor/shared_capacitor_mk5.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_space_capacitor_capacitor_mk5, "object/draft_schematic/space/capacitor/capacitor_mk5.iff")
