...
object_draft_schematic_space_weapon_wpn_advanced_ioncannon = object_draft_schematic_space_weapon_shared_wpn_advanced_ioncannon:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Advanced Ion Cannon",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_advanced_ioncannon.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_advanced_ioncannon, "object/draft_schematic/space/weapon/wpn_advanced_ioncannon.iff")
