...
object_draft_schematic_space_weapon_wpn_experimental_ioncannon = object_draft_schematic_space_weapon_shared_wpn_experimental_ioncannon:new {
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_experimental_ioncannon.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_experimental_ioncannon, "object/draft_schematic/space/weapon/wpn_experimental_ioncannon.iff")
