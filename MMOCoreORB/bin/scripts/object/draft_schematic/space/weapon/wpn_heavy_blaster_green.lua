...
object_draft_schematic_space_weapon_wpn_heavy_blaster_green = object_draft_schematic_space_weapon_shared_wpn_heavy_blaster_green:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Heavy Blaster (Green)",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_heavy_blaster_green.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_heavy_blaster_green, "object/draft_schematic/space/weapon/wpn_heavy_blaster_green.iff")
