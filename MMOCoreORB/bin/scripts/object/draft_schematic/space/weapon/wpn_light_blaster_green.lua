...
object_draft_schematic_space_weapon_wpn_light_blaster_green = object_draft_schematic_space_weapon_shared_wpn_light_blaster_green:new {
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_light_blaster_green.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_light_blaster_green, "object/draft_schematic/space/weapon/wpn_light_blaster_green.iff")
