...
object_draft_schematic_space_weapon_wpn_heavy_disruptor = object_draft_schematic_space_weapon_shared_wpn_heavy_disruptor:new {
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_heavy_disruptor.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_heavy_disruptor, "object/draft_schematic/space/weapon/wpn_heavy_disruptor.iff")
