...
object_draft_schematic_space_weapon_wpn_heavy_ioncannon = object_draft_schematic_space_weapon_shared_wpn_heavy_ioncannon:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Heavy Ion Cannon",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_heavy_ioncannon.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_heavy_ioncannon, "object/draft_schematic/space/weapon/wpn_heavy_ioncannon.iff")
