...
object_draft_schematic_space_weapon_wpn_medium_ioncannon = object_draft_schematic_space_weapon_shared_wpn_medium_ioncannon:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Mid-Grade Ion Cannon",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_medium_ioncannon.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_medium_ioncannon, "object/draft_schematic/space/weapon/wpn_medium_ioncannon.iff")
