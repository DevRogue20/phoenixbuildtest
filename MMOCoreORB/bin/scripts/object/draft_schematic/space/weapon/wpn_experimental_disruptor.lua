...
object_draft_schematic_space_weapon_wpn_experimental_disruptor = object_draft_schematic_space_weapon_shared_wpn_experimental_disruptor:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Experimental Disruptor",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_experimental_disruptor.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_experimental_disruptor, "object/draft_schematic/space/weapon/wpn_experimental_disruptor.iff")
