...
object_draft_schematic_space_weapon_wpn_light_ioncannon = object_draft_schematic_space_weapon_shared_wpn_light_ioncannon:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Light Ion Cannon",
	...
	targetTemplate = "object/tangible/ship/crafted/weapon/wpn_light_ioncannon.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_weapon_wpn_light_ioncannon, "object/draft_schematic/space/weapon/wpn_light_ioncannon.iff")
