...
object_draft_schematic_space_booster_booster_mk4 = object_draft_schematic_space_booster_shared_booster_mk4:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mark IV Booster",
   ...
   targetTemplate = "object/tangible/ship/crafted/booster/booster_mk4.iff",

   additionalTemplates = {
              "object/tangible/ship/crafted/booster/shared_booster_mk4.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_space_booster_booster_mk4, "object/draft_schematic/space/booster/booster_mk4.iff")
