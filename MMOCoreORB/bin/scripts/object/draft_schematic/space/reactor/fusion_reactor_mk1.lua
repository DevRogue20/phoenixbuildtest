...
object_draft_schematic_space_reactor_fusion_reactor_mk1 = object_draft_schematic_space_reactor_shared_fusion_reactor_mk1:new {
   ...
   targetTemplate = "object/tangible/ship/crafted/reactor/fusion_reactor_mk1.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_space_reactor_fusion_reactor_mk1, "object/draft_schematic/space/reactor/fusion_reactor_mk1.iff")
