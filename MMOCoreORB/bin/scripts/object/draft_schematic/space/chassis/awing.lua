...
object_draft_schematic_space_chassis_awing = object_draft_schematic_space_chassis_shared_awing:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/awing_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_awing, "object/draft_schematic/space/chassis/awing.iff")
