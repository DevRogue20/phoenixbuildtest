...
object_draft_schematic_space_chassis_ykl37r = object_draft_schematic_space_chassis_shared_ykl37r:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/ykl37r_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_ykl37r, "object/draft_schematic/space/chassis/ykl37r.iff")
