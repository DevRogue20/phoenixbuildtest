...
object_draft_schematic_space_chassis_ywing_longprobe = object_draft_schematic_space_chassis_shared_ywing_longprobe:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/ywing_longprobe_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_ywing_longprobe, "object/draft_schematic/space/chassis/ywing_longprobe.iff")
