...
object_draft_schematic_space_chassis_decimator = object_draft_schematic_space_chassis_shared_decimator:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/decimator_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_decimator, "object/draft_schematic/space/chassis/decimator.iff")
