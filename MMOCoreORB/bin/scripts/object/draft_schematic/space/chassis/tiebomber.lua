...
object_draft_schematic_space_chassis_tiebomber = object_draft_schematic_space_chassis_shared_tiebomber:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/tiebomber_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_tiebomber, "object/draft_schematic/space/chassis/tiebomber.iff")
