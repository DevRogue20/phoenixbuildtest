...
object_draft_schematic_space_chassis_tiefighter = object_draft_schematic_space_chassis_shared_tiefighter:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/tiefighter_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_tiefighter, "object/draft_schematic/space/chassis/tiefighter.iff")
