...
object_draft_schematic_space_chassis_blacksun_medium_s01 = object_draft_schematic_space_chassis_shared_blacksun_medium_s01:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Ixiyen Fast Attack Craft Chassis Blueprints, Style 1",
	...
	targetTemplate = "object/tangible/ship/components/chassis/blacksun_medium_s01_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_blacksun_medium_s01, "object/draft_schematic/space/chassis/blacksun_medium_s01.iff")
