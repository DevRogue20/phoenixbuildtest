...
object_draft_schematic_space_chassis_hutt_turret_ship = object_draft_schematic_space_chassis_shared_hutt_turret_ship:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/hutt_turret_ship_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_hutt_turret_ship, "object/draft_schematic/space/chassis/hutt_turret_ship.iff")
