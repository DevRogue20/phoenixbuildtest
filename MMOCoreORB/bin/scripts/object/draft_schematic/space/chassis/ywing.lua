...
object_draft_schematic_space_chassis_ywing = object_draft_schematic_space_chassis_shared_ywing:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/ywing_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_ywing, "object/draft_schematic/space/chassis/ywing.iff")
