...
object_draft_schematic_space_chassis_tieinterceptor = object_draft_schematic_space_chassis_shared_tieinterceptor:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/tieinterceptor_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_tieinterceptor, "object/draft_schematic/space/chassis/tieinterceptor.iff")
