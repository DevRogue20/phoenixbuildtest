...
object_draft_schematic_space_chassis_tie_in = object_draft_schematic_space_chassis_shared_tie_in:new {
	...
	targetTemplate = "object/tangible/ship/components/chassis/tie_in_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_tie_in, "object/draft_schematic/space/chassis/tie_in.iff")
