...
object_draft_schematic_space_chassis_yt1300 = object_draft_schematic_space_chassis_shared_yt1300:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "YT-1300 Chassis Blueprints",
	...
	targetTemplate = "object/tangible/ship/components/chassis/yt1300_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_yt1300, "object/draft_schematic/space/chassis/yt1300.iff")
