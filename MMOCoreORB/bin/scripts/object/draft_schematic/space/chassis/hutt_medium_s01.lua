...
object_draft_schematic_space_chassis_hutt_medium_s01 = object_draft_schematic_space_chassis_shared_hutt_medium_s01:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Dunelizard Chassis Blueprints, Style 1",
	...
	targetTemplate = "object/tangible/ship/components/chassis/hutt_medium_s01_chassis_token.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_space_chassis_hutt_medium_s01, "object/draft_schematic/space/chassis/hutt_medium_s01.iff")
