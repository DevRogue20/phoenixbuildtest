...
object_draft_schematic_space_droid_interface_ddi_mk5 = object_draft_schematic_space_droid_interface_shared_ddi_mk5:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mark V Droid Interface",
   ...
   targetTemplate = "object/tangible/ship/crafted/droid_interface/ddi_mk5.iff",

   additionalTemplates = {
              "object/tangible/ship/crafted/droid_interface/shared_ddi_mk5.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_space_droid_interface_ddi_mk5, "object/draft_schematic/space/droid_interface/ddi_mk5.iff")
