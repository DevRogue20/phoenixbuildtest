...
object_draft_schematic_space_shields_light_deflector_shields = object_draft_schematic_space_shields_shared_light_deflector_shields:new {
   ...
   targetTemplate = "object/tangible/ship/crafted/shields/light_deflector_shields.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_space_shields_light_deflector_shields, "object/draft_schematic/space/shields/light_deflector_shields.iff")
