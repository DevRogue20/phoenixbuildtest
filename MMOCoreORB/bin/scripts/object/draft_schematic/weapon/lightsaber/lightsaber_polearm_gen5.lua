...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen5 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_gen5:new {
    ...
    additionalTemplates = {
               "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_s1_gen5.iff",
               "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_s2_gen5.iff",
              }
