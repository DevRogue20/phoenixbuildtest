...
object_draft_schematic_bio_engineer_creature_creature_gurrcat = object_draft_schematic_bio_engineer_creature_shared_creature_gurrcat:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Gurrcat",
   ...
   resourceQuantities = {1, 50, 35},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/gurrcat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gurrcat, "object/draft_schematic/bio_engineer/creature/creature_gurrcat.iff")
