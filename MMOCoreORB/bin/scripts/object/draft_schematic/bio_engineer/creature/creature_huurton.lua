...
object_draft_schematic_bio_engineer_creature_creature_huurton = object_draft_schematic_bio_engineer_creature_shared_creature_huurton:new {
   ...
   resourceQuantities = {1, 45, 25},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/huurton_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_huurton, "object/draft_schematic/bio_engineer/creature/creature_huurton.iff")
