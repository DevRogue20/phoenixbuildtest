...
object_draft_schematic_bio_engineer_creature_creature_sand_panther = object_draft_schematic_bio_engineer_creature_shared_creature_sand_panther:new {
   ...
   resourceQuantities = {1, 85, 70},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/sand_panther_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_sand_panther, "object/draft_schematic/bio_engineer/creature/creature_sand_panther.iff")
