...
object_draft_schematic_bio_engineer_creature_creature_veermok = object_draft_schematic_bio_engineer_creature_shared_creature_veermok:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Veermok",
   ...
   resourceQuantities = {1, 85, 80},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/veermok_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_veermok, "object/draft_schematic/bio_engineer/creature/creature_veermok.iff")
