...
object_draft_schematic_bio_engineer_creature_creature_dune_lizard = object_draft_schematic_bio_engineer_creature_shared_creature_dune_lizard:new {
   ...
   resourceQuantities = {1, 55, 40},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/dune_lizard_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_dune_lizard, "object/draft_schematic/bio_engineer/creature/creature_dune_lizard.iff")
