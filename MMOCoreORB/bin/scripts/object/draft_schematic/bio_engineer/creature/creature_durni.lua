...
object_draft_schematic_bio_engineer_creature_creature_durni = object_draft_schematic_bio_engineer_creature_shared_creature_durni:new {
   ...
   resourceQuantities = {1, 15, 15},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/durni_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_durni, "object/draft_schematic/bio_engineer/creature/creature_durni.iff")
