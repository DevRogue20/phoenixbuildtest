...
object_draft_schematic_bio_engineer_creature_creature_bordok = object_draft_schematic_bio_engineer_creature_shared_creature_bordok:new {
   ...
   resourceQuantities = {1, 30, 60},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/bordok_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bordok, "object/draft_schematic/bio_engineer/creature/creature_bordok.iff")
