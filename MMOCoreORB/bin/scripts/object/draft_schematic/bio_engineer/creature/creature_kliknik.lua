...
object_draft_schematic_bio_engineer_creature_creature_kliknik = object_draft_schematic_bio_engineer_creature_shared_creature_kliknik:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Kliknik",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kliknik_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kliknik, "object/draft_schematic/bio_engineer/creature/creature_kliknik.iff")
