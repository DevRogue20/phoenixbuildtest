...
object_draft_schematic_bio_engineer_creature_creature_slice_hound = object_draft_schematic_bio_engineer_creature_shared_creature_slice_hound:new {
   ...
   resourceQuantities = {1, 70, 55},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/slice_hound_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_slice_hound, "object/draft_schematic/bio_engineer/creature/creature_slice_hound.iff")
