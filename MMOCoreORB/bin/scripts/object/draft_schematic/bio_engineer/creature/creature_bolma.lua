...
object_draft_schematic_bio_engineer_creature_creature_bolma = object_draft_schematic_bio_engineer_creature_shared_creature_bolma:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Bolma",
   ...
   resourceQuantities = {1, 55, 60},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/bolma_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bolma, "object/draft_schematic/bio_engineer/creature/creature_bolma.iff")
