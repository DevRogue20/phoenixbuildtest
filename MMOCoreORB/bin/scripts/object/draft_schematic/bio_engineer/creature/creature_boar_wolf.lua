...
object_draft_schematic_bio_engineer_creature_creature_boar_wolf = object_draft_schematic_bio_engineer_creature_shared_creature_boar_wolf:new {
   ...
   resourceQuantities = {1, 60, 35},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/boar_wolf_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_boar_wolf, "object/draft_schematic/bio_engineer/creature/creature_boar_wolf.iff")
