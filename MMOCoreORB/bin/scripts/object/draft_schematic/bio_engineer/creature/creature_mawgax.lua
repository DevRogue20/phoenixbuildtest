...
object_draft_schematic_bio_engineer_creature_creature_mawgax = object_draft_schematic_bio_engineer_creature_shared_creature_mawgax:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Mawgax",
   ...
   resourceQuantities = {1, 70, 75},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/mawgax_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mawgax, "object/draft_schematic/bio_engineer/creature/creature_mawgax.iff")
