...
object_draft_schematic_bio_engineer_creature_creature_kima = object_draft_schematic_bio_engineer_creature_shared_creature_kima:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Kima",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kima_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kima, "object/draft_schematic/bio_engineer/creature/creature_kima.iff")
