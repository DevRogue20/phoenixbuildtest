...
object_draft_schematic_bio_engineer_creature_creature_sharnaff = object_draft_schematic_bio_engineer_creature_shared_creature_sharnaff:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Sharnaff",
   ...
   resourceQuantities = {1, 80, 85},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/sharnaff_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_sharnaff, "object/draft_schematic/bio_engineer/creature/creature_sharnaff.iff")
