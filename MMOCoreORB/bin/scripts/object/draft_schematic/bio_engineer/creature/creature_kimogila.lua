...
object_draft_schematic_bio_engineer_creature_creature_kimogila = object_draft_schematic_bio_engineer_creature_shared_creature_kimogila:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kimogila_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kimogila, "object/draft_schematic/bio_engineer/creature/creature_kimogila.iff")
