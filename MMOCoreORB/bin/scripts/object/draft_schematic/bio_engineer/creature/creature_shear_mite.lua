...
object_draft_schematic_bio_engineer_creature_creature_shear_mite = object_draft_schematic_bio_engineer_creature_shared_creature_shear_mite:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Shear Mite",
...
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_shear_mite, "object/draft_schematic/bio_engineer/creature/creature_shear_mite.iff")
