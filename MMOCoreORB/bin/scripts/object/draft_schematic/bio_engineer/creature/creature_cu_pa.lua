...
object_draft_schematic_bio_engineer_creature_creature_cu_pa = object_draft_schematic_bio_engineer_creature_shared_creature_cu_pa:new {
   ...
   resourceQuantities = {1, 35, 55},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/cu_pa_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_cu_pa, "object/draft_schematic/bio_engineer/creature/creature_cu_pa.iff")
