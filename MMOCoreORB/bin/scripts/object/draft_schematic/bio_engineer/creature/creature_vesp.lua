...
object_draft_schematic_bio_engineer_creature_creature_vesp = object_draft_schematic_bio_engineer_creature_shared_creature_vesp:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Vesp",
   ...
   resourceQuantities = {1, 55, 50},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/vesp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_vesp, "object/draft_schematic/bio_engineer/creature/creature_vesp.iff")
