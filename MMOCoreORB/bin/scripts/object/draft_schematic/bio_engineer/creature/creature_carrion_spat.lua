...
object_draft_schematic_bio_engineer_creature_creature_carrion_spat = object_draft_schematic_bio_engineer_creature_shared_creature_carrion_spat:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/carrion_spat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_carrion_spat, "object/draft_schematic/bio_engineer/creature/creature_carrion_spat.iff")
