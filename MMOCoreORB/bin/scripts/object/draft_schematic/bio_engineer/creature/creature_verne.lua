...
object_draft_schematic_bio_engineer_creature_creature_verne = object_draft_schematic_bio_engineer_creature_shared_creature_verne:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Verne",
   ...
   resourceQuantities = {1, 30, 50},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/verne_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_verne, "object/draft_schematic/bio_engineer/creature/creature_verne.iff")
