...
object_draft_schematic_bio_engineer_creature_creature_torton = object_draft_schematic_bio_engineer_creature_shared_creature_torton:new {
   ...
   resourceQuantities = {1, 100, 80},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/torton_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_torton, "object/draft_schematic/bio_engineer/creature/creature_torton.iff")
