...
object_draft_schematic_bio_engineer_creature_creature_eopie = object_draft_schematic_bio_engineer_creature_shared_creature_eopie:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/eopie_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_eopie, "object/draft_schematic/bio_engineer/creature/creature_eopie.iff")
