...
object_draft_schematic_bio_engineer_creature_creature_brackaset = object_draft_schematic_bio_engineer_creature_shared_creature_brackaset:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Brackaset",
...
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_brackaset, "object/draft_schematic/bio_engineer/creature/creature_brackaset.iff")
