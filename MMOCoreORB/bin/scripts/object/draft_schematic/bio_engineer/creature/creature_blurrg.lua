...
object_draft_schematic_bio_engineer_creature_creature_blurrg = object_draft_schematic_bio_engineer_creature_shared_creature_blurrg:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Blurrg",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/blurrg_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_blurrg, "object/draft_schematic/bio_engineer/creature/creature_blurrg.iff")
