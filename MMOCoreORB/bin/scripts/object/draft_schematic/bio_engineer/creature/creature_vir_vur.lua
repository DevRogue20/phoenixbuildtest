...
object_draft_schematic_bio_engineer_creature_creature_vir_vur = object_draft_schematic_bio_engineer_creature_shared_creature_vir_vur:new {
   ...
   resourceQuantities = {1, 20, 20},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/vir_vur_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_vir_vur, "object/draft_schematic/bio_engineer/creature/creature_vir_vur.iff")
