...
object_draft_schematic_bio_engineer_creature_creature_bol = object_draft_schematic_bio_engineer_creature_shared_creature_bol:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Bol",
   ...
   resourceQuantities = {1, 50, 70},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/bol_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bol, "object/draft_schematic/bio_engineer/creature/creature_bol.iff")
