...
object_draft_schematic_bio_engineer_creature_creature_ronto = object_draft_schematic_bio_engineer_creature_shared_creature_ronto:new {
   ...
   resourceQuantities = {1, 65, 80},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/ronto_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_ronto, "object/draft_schematic/bio_engineer/creature/creature_ronto.iff")
