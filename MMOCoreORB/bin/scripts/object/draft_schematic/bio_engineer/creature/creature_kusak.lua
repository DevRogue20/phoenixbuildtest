...
object_draft_schematic_bio_engineer_creature_creature_kusak = object_draft_schematic_bio_engineer_creature_shared_creature_kusak:new {
   ...
   resourceQuantities = {1, 50, 40},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/kusak_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kusak, "object/draft_schematic/bio_engineer/creature/creature_kusak.iff")
