...
object_draft_schematic_bio_engineer_creature_creature_narglatch = object_draft_schematic_bio_engineer_creature_shared_creature_narglatch:new {
   ...
   resourceQuantities = {1, 65, 75},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/narglatch_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_narglatch, "object/draft_schematic/bio_engineer/creature/creature_narglatch.iff")
