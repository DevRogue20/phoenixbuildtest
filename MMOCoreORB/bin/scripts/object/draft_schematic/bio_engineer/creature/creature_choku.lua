...
object_draft_schematic_bio_engineer_creature_creature_choku = object_draft_schematic_bio_engineer_creature_shared_creature_choku:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/choku_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_choku, "object/draft_schematic/bio_engineer/creature/creature_choku.iff")
