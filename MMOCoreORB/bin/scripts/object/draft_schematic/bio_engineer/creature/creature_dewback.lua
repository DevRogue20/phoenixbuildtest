...
object_draft_schematic_bio_engineer_creature_creature_dewback = object_draft_schematic_bio_engineer_creature_shared_creature_dewback:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/dewback_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_dewback, "object/draft_schematic/bio_engineer/creature/creature_dewback.iff")
