...
object_draft_schematic_bio_engineer_creature_creature_mott = object_draft_schematic_bio_engineer_creature_shared_creature_mott:new {
   ...
   resourceQuantities = {1, 35, 25},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/mott_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mott, "object/draft_schematic/bio_engineer/creature/creature_mott.iff")
