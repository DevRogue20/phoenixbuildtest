...
object_draft_schematic_bio_engineer_creature_creature_gualama = object_draft_schematic_bio_engineer_creature_shared_creature_gualama:new {
   ...
   resourceQuantities = {1, 45, 35},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/gualama_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gualama, "object/draft_schematic/bio_engineer/creature/creature_gualama.iff")
