...
object_draft_schematic_bio_engineer_creature_creature_pugoriss = object_draft_schematic_bio_engineer_creature_shared_creature_pugoriss:new {
   ...
   resourceQuantities = {1, 55, 45},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/pugoriss_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_pugoriss, "object/draft_schematic/bio_engineer/creature/creature_pugoriss.iff")
