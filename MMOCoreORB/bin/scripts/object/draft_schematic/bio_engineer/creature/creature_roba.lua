...
object_draft_schematic_bio_engineer_creature_creature_roba = object_draft_schematic_bio_engineer_creature_shared_creature_roba:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/roba_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_roba, "object/draft_schematic/bio_engineer/creature/creature_roba.iff")
