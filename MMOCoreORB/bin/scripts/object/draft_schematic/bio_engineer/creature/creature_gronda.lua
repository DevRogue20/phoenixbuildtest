...
object_draft_schematic_bio_engineer_creature_creature_gronda = object_draft_schematic_bio_engineer_creature_shared_creature_gronda:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gronda, "object/draft_schematic/bio_engineer/creature/creature_gronda.iff")
