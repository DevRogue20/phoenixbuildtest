...
object_draft_schematic_bio_engineer_creature_creature_ikopi = object_draft_schematic_bio_engineer_creature_shared_creature_ikopi:new {
   ...
   resourceQuantities = {1, 20, 35},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/ikopi_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_ikopi, "object/draft_schematic/bio_engineer/creature/creature_ikopi.iff")
