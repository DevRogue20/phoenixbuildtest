...
object_draft_schematic_bio_engineer_creature_creature_guf_drolg = object_draft_schematic_bio_engineer_creature_shared_creature_guf_drolg:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/guf_drolg_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_guf_drolg, "object/draft_schematic/bio_engineer/creature/creature_guf_drolg.iff")
