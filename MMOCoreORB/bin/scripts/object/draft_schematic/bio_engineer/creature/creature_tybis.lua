...
object_draft_schematic_bio_engineer_creature_creature_tybis = object_draft_schematic_bio_engineer_creature_shared_creature_tybis:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Tybis",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/tybis_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_tybis, "object/draft_schematic/bio_engineer/creature/creature_tybis.iff")
