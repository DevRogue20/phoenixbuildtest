...
object_draft_schematic_bio_engineer_creature_creature_bantha = object_draft_schematic_bio_engineer_creature_shared_creature_bantha:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Bantha",
...
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bantha, "object/draft_schematic/bio_engineer/creature/creature_bantha.iff")
