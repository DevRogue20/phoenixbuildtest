...
object_draft_schematic_bio_engineer_creature_creature_gurreck = object_draft_schematic_bio_engineer_creature_shared_creature_gurreck:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Gurreck",
...
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gurreck, "object/draft_schematic/bio_engineer/creature/creature_gurreck.iff")
