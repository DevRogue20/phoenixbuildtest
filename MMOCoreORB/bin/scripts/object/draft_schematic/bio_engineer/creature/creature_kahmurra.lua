...
object_draft_schematic_bio_engineer_creature_creature_kahmurra = object_draft_schematic_bio_engineer_creature_shared_creature_kahmurra:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Kahmurra",
   ...
   resourceQuantities = {1, 50, 45},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/kahmurra_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kahmurra, "object/draft_schematic/bio_engineer/creature/creature_kahmurra.iff")
