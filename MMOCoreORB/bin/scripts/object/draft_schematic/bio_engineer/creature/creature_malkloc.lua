...
object_draft_schematic_bio_engineer_creature_creature_malkloc = object_draft_schematic_bio_engineer_creature_shared_creature_malkloc:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 1000,

   customObjectName = "Malkloc",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/malkloc_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_malkloc, "object/draft_schematic/bio_engineer/creature/creature_malkloc.iff")
