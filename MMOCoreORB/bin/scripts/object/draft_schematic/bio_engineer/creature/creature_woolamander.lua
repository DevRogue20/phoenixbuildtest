...
object_draft_schematic_bio_engineer_creature_creature_woolamander = object_draft_schematic_bio_engineer_creature_shared_creature_woolamander:new {
   ...
   resourceQuantities = {1, 70, 80},
   contribution = {100, 100, 100},


   targetTemplate = "object/tangible/deed/pet_deed/woolamander_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_woolamander, "object/draft_schematic/bio_engineer/creature/creature_woolamander.iff")
