...
object_weapon_ranged_pistol_pistol_striker = object_weapon_ranged_pistol_shared_pistol_striker:new {
	...
	certificationsRequired = { "cert_pistol_striker" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_striker, "object/weapon/ranged/pistol/pistol_striker.iff")
