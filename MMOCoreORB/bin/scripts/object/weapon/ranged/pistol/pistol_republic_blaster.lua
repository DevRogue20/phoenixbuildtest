...
object_weapon_ranged_pistol_pistol_republic_blaster = object_weapon_ranged_pistol_shared_pistol_republic_blaster:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_republic_blaster, "object/weapon/ranged/pistol/pistol_republic_blaster.iff")
