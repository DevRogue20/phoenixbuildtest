...
object_weapon_ranged_pistol_pistol_tangle = object_weapon_ranged_pistol_shared_pistol_tangle:new {
	...
	certificationsRequired = { "cert_pistol_tangle" },
	...
	experimentalMin = {0, 0, 32, 51, 4.8, 2, 1, 750, -5, -80, 10, -10, 16, 33, 26},
