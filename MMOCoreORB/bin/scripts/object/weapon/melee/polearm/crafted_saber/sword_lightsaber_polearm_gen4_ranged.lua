...
object_weapon_melee_polearm_crafted_saber_sword_lightsaber_polearm_gen4_ranged = object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_polearm_gen4:new {
	customObjectName = "Dark Jedi Ranged AI Lightsaber",
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_crafted_saber_sword_lightsaber_polearm_gen4_ranged, "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_gen4_ranged.iff")
