...
object_weapon_melee_polearm_lance_staff_wood_s2 = object_weapon_melee_polearm_shared_lance_staff_wood_s2:new {
	...
	certificationsRequired = { "cert_lance_staff_wood_s2" },
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_lance_staff_wood_s2, "object/weapon/melee/polearm/lance_staff_wood_s2.iff")
