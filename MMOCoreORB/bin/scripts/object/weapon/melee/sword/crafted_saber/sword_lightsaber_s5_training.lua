...
ObjectTemplates:addTemplate(object_weapon_melee_sword_crafted_saber_sword_lightsaber_s5_training, "object/weapon/melee/sword/crafted_saber/sword_lightsaber_s5_training.iff")
