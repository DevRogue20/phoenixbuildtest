...
object_weapon_melee_sword_sword_lightsaber_sleekblack = object_weapon_melee_sword_shared_sword_lightsaber_sleekblack:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_sleekblack, "object/weapon/melee/sword/sword_lightsaber_sleekblack.iff")
