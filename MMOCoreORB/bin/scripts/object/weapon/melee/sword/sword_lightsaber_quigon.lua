...
object_weapon_melee_sword_sword_lightsaber_quigon = object_weapon_melee_sword_shared_sword_lightsaber_quigon:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_quigon, "object/weapon/melee/sword/sword_lightsaber_quigon.iff")
