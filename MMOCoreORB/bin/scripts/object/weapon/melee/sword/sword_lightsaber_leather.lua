...
object_weapon_melee_sword_sword_lightsaber_leather = object_weapon_melee_sword_shared_sword_lightsaber_leather:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_leather, "object/weapon/melee/sword/sword_lightsaber_leather.iff")
