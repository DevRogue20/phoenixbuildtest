...
object_weapon_melee_sword_sword_lightsaber_vader = object_weapon_melee_sword_shared_sword_lightsaber_vader:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_vader, "object/weapon/melee/sword/sword_lightsaber_vader.iff")
