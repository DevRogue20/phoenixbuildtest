...
object_weapon_melee_sword_sword_lightsaber_andael = object_weapon_melee_sword_shared_sword_lightsaber_andael:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_andael, "object/weapon/melee/sword/sword_lightsaber_andael.iff")
