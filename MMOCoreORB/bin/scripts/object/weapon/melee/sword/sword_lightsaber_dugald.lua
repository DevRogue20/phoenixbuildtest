...
object_weapon_melee_sword_sword_lightsaber_dugald = object_weapon_melee_sword_shared_sword_lightsaber_dugald:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_sword_lightsaber_dugald, "object/weapon/melee/sword/sword_lightsaber_dugald.iff")
