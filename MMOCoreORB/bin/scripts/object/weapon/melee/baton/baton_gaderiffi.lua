...
object_weapon_melee_baton_baton_gaderiffi = object_weapon_melee_baton_shared_baton_gaderiffi:new {
	...
	certificationsRequired = { "cert_baton_gaderiffi" },
...
ObjectTemplates:addTemplate(object_weapon_melee_baton_baton_gaderiffi, "object/weapon/melee/baton/baton_gaderiffi.iff")
