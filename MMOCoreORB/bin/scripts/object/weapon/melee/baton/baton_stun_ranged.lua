...
object_weapon_melee_baton_baton_stun_ranged = object_weapon_melee_baton_shared_baton_stun:new {
	customObjectName = "Force User AI Ranged Sword",
...
ObjectTemplates:addTemplate(object_weapon_melee_baton_baton_stun_ranged, "object/weapon/melee/baton/baton_stun_ranged.iff")