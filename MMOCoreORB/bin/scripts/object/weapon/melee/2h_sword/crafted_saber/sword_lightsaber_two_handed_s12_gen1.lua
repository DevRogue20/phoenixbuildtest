...
ObjectTemplates:addTemplate(object_weapon_melee_2h_sword_crafted_saber_sword_lightsaber_two_handed_s12_gen1, "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_s12_gen1.iff")
