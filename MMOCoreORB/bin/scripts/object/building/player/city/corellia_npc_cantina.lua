...
object_building_player_city_corellia_npc_cantina = object_building_player_city_shared_corellia_npc_cantina:new {
	lotSize = 5,
...
ObjectTemplates:addTemplate(object_building_player_city_corellia_npc_cantina, "object/building/player/city/corellia_npc_cantina.iff")
