...
object_building_player_city_tatooine_npc_cantina = object_building_player_city_shared_tatooine_npc_cantina:new {
	lotSize = 5,
...
ObjectTemplates:addTemplate(object_building_player_city_tatooine_npc_cantina, "object/building/player/city/tatooine_npc_cantina.iff")
