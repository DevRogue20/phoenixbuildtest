...
ObjectTemplates:addTemplate(object_tangible_component_armor_shield_generator_personal_b, "object/tangible/component/armor/shield_generator_personal_b.iff")
