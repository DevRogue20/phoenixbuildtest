...
object_tangible_wearables_robe_robe_jedi_dark_s02 = object_tangible_wearables_robe_shared_robe_jedi_dark_s02:new {
	...
	certificationsRequired = {"jedi_dark_side_journeyman_master"},
	attributeListComponent = "JediRobeAttributeListComponent",
}

ObjectTemplates:addTemplate(object_tangible_wearables_robe_robe_jedi_dark_s02, "object/tangible/wearables/robe/robe_jedi_dark_s02.iff")
