...
object_tangible_wearables_cyborg_arm_r_s01 = object_tangible_wearables_cyborg_shared_arm_r_s01:new {
	playerRaces = { "object/creature/player/bothan_male.iff",
		...
		"object/creature/player/zeltron_male.iff",
				...
				objectMenuComponent = "ResarmMenuComponent",
				attributeListComponent = "ResarmAttributeListComponent",
				dataObjectComponent = "ResarmDataComponent",
}

ObjectTemplates:addTemplate(object_tangible_wearables_cyborg_arm_r_s01, "object/tangible/wearables/cyborg/arm_r_s01.iff")
