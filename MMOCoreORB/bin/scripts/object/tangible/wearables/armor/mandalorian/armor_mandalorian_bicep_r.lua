...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_armor_mandalorian_bicep_r, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_bicep_r.iff")
