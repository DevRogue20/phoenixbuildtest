...
object_tangible_wearables_armor_mandalorian_armor_mandalorian_helmet_invis = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_helmet_invis:new {
	templateType = ARMOROBJECT,

	customName = "Armor Mandalorian Helmet INVISIBLE",	
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_armor_mandalorian_helmet_invis, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_helmet_invis.iff")
