...
object_tangible_wearables_armor_stormtrooper_shared_order_stormtrooper_helmet = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/armor/stormtrooper/shared_order_stormtrooper_helmet.iff"
	
}

ObjectTemplates:addClientTemplate(object_tangible_wearables_armor_stormtrooper_shared_order_stormtrooper_helmet, "object/tangible/wearables/armor/stormtrooper/shared_order_stormtrooper_helmet.iff")
