...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_padded_armor_padded_s01_helmet, "object/tangible/wearables/armor/padded/armor_padded_s01_helmet.iff")
