...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_ithorian_guardian_ith_armor_s02_boots, "object/tangible/wearables/armor/ithorian_guardian/ith_armor_s02_boots.iff")
