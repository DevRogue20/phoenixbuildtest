...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_bounty_hunter_armor_bounty_hunter_boots, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_boots.iff")
