...
object_tangible_wearables_armor_ris_armor_ris_bracer_l = object_tangible_wearables_armor_ris_shared_armor_ris_bracer_l:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_ris_armor_ris_bracer_l, "object/tangible/wearables/armor/ris/armor_ris_bracer_l.iff")
