...
object_tangible_wearables_armor_ris_armor_ris_boots = object_tangible_wearables_armor_ris_shared_armor_ris_boots:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_ris_armor_ris_boots, "object/tangible/wearables/armor/ris/armor_ris_boots.iff")
