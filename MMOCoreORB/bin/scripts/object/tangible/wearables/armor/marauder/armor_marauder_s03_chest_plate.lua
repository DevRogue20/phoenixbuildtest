...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_marauder_armor_marauder_s03_chest_plate, "object/tangible/wearables/armor/marauder/armor_marauder_s03_chest_plate.iff")
