...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_marauder_armor_marauder_s02_boots, "object/tangible/wearables/armor/marauder/armor_marauder_s02_boots.iff")
