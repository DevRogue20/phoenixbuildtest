...
object_tangible_wearables_armor_composite_armor_composite_helmet_invis = object_tangible_wearables_armor_composite_shared_armor_composite_helmet_invis:new {

	customName = "Armor Composite Helmet INVISIBLE",	
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_composite_armor_composite_helmet_invis, "object/tangible/wearables/armor/composite/armor_composite_helmet_invis.iff")
