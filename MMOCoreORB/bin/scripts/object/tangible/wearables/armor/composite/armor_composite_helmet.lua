...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_composite_armor_composite_helmet, "object/tangible/wearables/armor/composite/armor_composite_helmet.iff")
