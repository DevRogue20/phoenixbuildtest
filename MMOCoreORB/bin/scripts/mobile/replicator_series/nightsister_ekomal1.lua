nightsister_ekomal1 = Creature:new {
	objectName = "@mob/creature_names:nightsister_ranger",
	customName = "Ekomal Cin",
	socialGroup = "rancor",
	faction = "nightsister",
	level = 200,
	chanceHit = 200,
	...
	baseHAMmax = 315000,
	armor = 1,
	resists = {90,90,90,90,90,90,10,90,90},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(nightsister_ekomal1, "nightsister_ekomal1")
