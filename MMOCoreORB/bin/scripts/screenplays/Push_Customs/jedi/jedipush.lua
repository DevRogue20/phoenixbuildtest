...
function jedipush:spawnMobiles()
    ...
    local pMobile = spawnMobile("dungeon2", "trainer_jedi_dark", 1, 13.6, -4.2, -159.3, 90, 14201901, "calm")
    local pMobile = spawnMobile("dungeon2", "trainer_jedi_light", 1, 41.4, -4.2, -159.3, -90, 14201901, "calm")
end
