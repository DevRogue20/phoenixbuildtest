...
function jedipush_objects:spawnSceneObjects()
    ...
    spawnSceneObject("dungeon2", "object/tangible/terminal/terminal_jedi_robe.iff", 12.9, -4.2, -159.3, 14201901, math.rad(90) )
    ...
    spawnSceneObject("dungeon2", "object/tangible/terminal/terminal_jedi_robe.iff", 12.9, -4.2, -161.4, 14201903, math.rad(90) )
    ...
    spawnSceneObject("dungeon2", "object/tangible/veteran_reward/frn_vet_rug_imperial.iff", 27.5, -4.2, -161.7, 610000432, math.rad(90) )
    spawnSceneObject("dungeon2", "object/tangible/terminal/terminal_jedi_robe.iff", 12.9, -4.2, -161.4, 610000432, math.rad(90) )
end