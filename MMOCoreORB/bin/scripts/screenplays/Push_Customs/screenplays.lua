...
includeFile("Push_Customs/tatooine_bestine.lua")
includeFile("Push_Customs/sher_kar.lua")
includeFile("Push_Customs/sher_kar_objects.lua")
...
includeFile("Push_Customs/dws/dws.lua")
...
includeFile("Push_Customs/gcw/bestine_invasion.lua")
