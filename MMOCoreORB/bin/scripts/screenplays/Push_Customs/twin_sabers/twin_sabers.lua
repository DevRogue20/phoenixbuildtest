...
--[[Palpatine cave
	...
	if (pCell ~= nil) then
		...
		spawnMobile(planet, mid, 1300, 65, 0.4, 3.6, 22, 14201899)
		spawnMobile(planet, mid, 1300, 61, -0.2, 5.2, 87, 14201899)
		spawnMobile(planet, mid, 1300, 64, 0.1, 9.1, 172, 14201899)
		spawnMobile(planet, hard, 3600, 67, 0.1, 5.5, -87, 14201899)
	--end
