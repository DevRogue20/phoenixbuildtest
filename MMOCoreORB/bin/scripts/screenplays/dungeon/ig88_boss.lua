...
function ig88_boss:spawnMobiles()
	local pTrigger = spawnMobile("dungeon2", "ig_mouse_droid", 3600, 0, 0, 0, -99, 14200138)
...
function ig88_boss:notifyTriggerDead(pTrigger, pPlayer)
        local pBoss = spawnMobile("dungeon2", "ig88_npc_boss", 0, 0, 0, -18, 0, 14200138) print("spawned IG-88")
	ObjectManager.withCreatureObject(pBoss, function(oBoss)
		writeData("ig88_boss:spawnState", 1)
		writeData("ig88boss", oBoss:getObjectID())
		spatialChat(pBoss, "Intruder Alert Activating Defense Systems - TERMINATE")
...
--			boss:setOptionsBitmask(128)			
		...
		if (((bossHealth <= (bossMaxHealth *0.9)) or (bossAction <= (bossMaxAction * 0.9)) or (bossMind <= (bossMaxMind *0.9))) and readData("ig88_boss:spawnState") == 1) then
			...
			local pAdd = spawnMobile("dungeon2", "ig_battle_droid", 0, -20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddTwo = spawnMobile("dungeon2", "ig_battle_droid", 0, 20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddThree = spawnMobile("dungeon2", "ig_battle_droid", 0, 20.0, 0.0, -23.0, 0, 14200138)
			...
			local pAddFour = spawnMobile("dungeon2", "ig_battle_droid", 0, -20.0, 0.0, -23.0, 0, 14200138)
		...
		if (((bossHealth <= (bossMaxHealth * 0.7)) or (bossAction <= (bossMaxAction * 0.7)) or (bossMind <= (bossMaxMind * 0.7))) and readData("ig88_boss:spawnState") == 2) then
			...
			local pAddFive = spawnMobile("dungeon2", "ig_droideka", 0, -20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddSix = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddSeven = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, -23.0, 0, 14200138)
			...
			local pAddEight = spawnMobile("dungeon2",  "ig_droideka", 0, -20.0, 0.0, -23.0, 0, 14200138)
		...
		if (((bossHealth <= (bossMaxHealth * 0.6)) or (bossAction <= (bossMaxAction * 0.6)) or (bossMind <= (bossMaxMind * 0.6))) and readData("ig88_boss:spawnState") == 3) then
			...
			local pAddNine = spawnMobile("dungeon2", "ig_droideka", 0, -20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddTen = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddEleven = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, -23.0, 0, 14200138)
			...
			local pAddTwelve = spawnMobile("dungeon2",  "ig_droideka", 0, -20.0, 0.0, -23.0, 0, 14200138)
		...
		if (((bossHealth <= (bossMaxHealth * 0.5)) or (bossAction <= (bossMaxAction * 0.5)) or (bossMind <= (bossMaxMind * 0.5))) and readData("ig88_boss:spawnState") == 4) then
			...
			local pAddThirteen = spawnMobile("dungeon2", "ig_droideka", 0, -20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddFourteen = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, 43.2, 177, 14200138)
			...
			local pAddFifteen = spawnMobile("dungeon2", "ig_droideka", 0, 20.0, 0.0, -23.0, 0, 14200138)
			...
			local pAddSixteen = spawnMobile("dungeon2",  "ig_droideka", 0, -20.0, 0.0, -23.0, 0, 14200138)
		...
		if (((bossHealth <= (bossMaxHealth * 0.4)) or (bossAction <= (bossMaxAction * 0.4)) or (bossMind <= (bossMaxMind * 0.4))) and readData("ig88_boss:spawnState") == 5) then
			...
			local pAddSeventeen = spawnMobile("dungeon2", "ig_elite_battle_droid", 0, -13.0, 0.0, 10.0, 177, 14200138)
			...
			local pAddEighteen = spawnMobile("dungeon2",  "ig_elite_battle_droid", 0, 13.0, 0.0, 10.0, 177, 14200138)
