...
function axkva_min_instance:boss_damage(pBoss3, pPlayer)
	...
	if (boss ~= nil) then
		...
		if (((bossHealth <= (bossMaxHealth *0.5)) or (bossAction <= (bossMaxAction * 0.5)) or (bossMind <= (bossMaxMind *0.5))) and readData("axkva_min_instance:spawnState") == 2) then
			...
			local pAdd = spawnMobile("dathomir", "nightsister_ekomal", 0, -49.1, 8.1, -7.7, -30, 281475025694547)
			...
			local pAddTwo = spawnMobile("dathomir", "nightsister_oxvul", 0, -65.4, 14.5, 39.3, 162, 281475025694547)
			...
			local pAddThree = spawnMobile("dathomir", "nightsister_doum", 0, -44.0, 8.0, 16.6, -74, 281475025694547)
